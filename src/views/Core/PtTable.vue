...
export default {
  ...
  methods: {
      ...
      exportExcel() {
          const header = ["名称", "类型","细分","数量", "价格", "实盘数量", "差额", "备注"] // 导出的表头名
          const filterVal = ["trName", "trType","trSubdivide","trNumber", "trPrice", "number", "xNumber", "trRemarks"]
          ...
          const filename = '配件记录' + (new Date()).toLocaleDateString();
