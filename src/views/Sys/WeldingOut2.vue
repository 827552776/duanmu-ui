  ...
  <div class="page-container">
    ...
    <div class="toolbar" style="float:left;padding-top:10px;padding-left:15px;">
      <el-form :inline="true" :model="filters" :size="size">
        <el-form-item>
          <el-input v-model="filters.name" placeholder="焊材名称"/>
        </el-form-item>
        <el-form-item>
          <el-input v-model="filters.deCompany" placeholder="调拨单位"/>
        </el-form-item>
        <el-form-item>
          <el-input v-model="filters.model" placeholder="型号"/>
        </el-form-item>
    ...
    <el-dialog :title="operation?'新增':'编辑'" width="80%" :visible.sync="editDialogVisible" :close-on-click-modal="false">
      <el-form :model="dataForm" label-width="120px" :rules="dataFormRules" ref="dataForm" :size="size">
        ...
        <el-row>
          ...
          <el-col :span="5">
            <el-form-item label="调拨单位" prop="label">
              <el-input v-model="dataForm.deCompany " auto-complete="off" />
            </el-form-item>
          </el-col>
          <el-col :span="5">
        ...
        <el-row>
          ...
          <el-col :span="5">
            <el-form-item label="调拨出库时间" prop="sort">
              <el-date-picker
                v-model="dataForm.deTime"
                type="date"
                placeholder="选择日期">
              </el-date-picker>
            </el-form-item>
          ...
          <el-col :span="6">
            <!--    出库时显示        -->
            <el-form-item label="调拨数量" prop="type">
              <el-input v-model="dataForm.deNumber " auto-complete="off" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
...
<script>
    ...
    import HanCaiDiaoTable from "../Core/HanCaiDiaoTable";
    export default {
        components:{
            KtTable,
            KtButton,
        ...
        data() {
            return {
                ...
                columns: [
                    ...
                    {prop:"deTime", label:"调拨出库时间", minWidth:120,formatter:this.dateFormat},
                    {prop:"deCompany", label:"调拨单位", minWidth:100},
                    {prop:"source", label:"来源", minWidth:100},
                  {prop:"model", label:"型号", minWidth:100},
                    {prop:"deNumber", label:"调拨数量", minWidth:100},
        ...
        methods: {
            ...
            findPage: function (data) {
                ...
                this.pageRequest.columnFilters = {name: {name:'name', value:this.filters.name},deCompany: {name:'deCompany', value:this.filters.deCompany},model: {name:'model', value:this.filters.model},
                  qianTime: {name:'qianTime', value:this.filters.qianTime},houTime: {name:'houTime', value:this.filters.houTime}}
                this.$api.weldingInt.findPageT(this.pageRequest).then((res) => {
