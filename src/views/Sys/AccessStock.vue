...
<!--        </el-form-item>-->
    ...
    <!--表格内容栏-->
    <kt-table :height="500" permsEdit="sys:dict:edit" permsDelete="sys:dict:delete"
    ...
    <el-dialog :title="operation?'新增':'编辑'" width="40%" :visible.sync="editDialogVisible" :close-on-click-modal="false">
      <el-form :model="dataForm" label-width="80px" :rules="dataFormRules" ref="dataForm" :size="size">
        ...
        <el-form-item label="出库数量" prop="sort">
        ...
        data() {
            return {
                ...
                columns: [
                    ...
                    {prop:"subdivide", label:"细分", minWidth:80},
                    {prop:"number", label:"入库数量", minWidth:80},
