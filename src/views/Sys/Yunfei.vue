<template>
  <div class="page-container">
    ...
    <!--表格内容栏-->
    <YunFeiTable :height="500" permsEdit="sys:dict:edit" permsDelete="sys:dict:delete"
        ...
        data() {
            return {
                ...
                columns: [
                    ...
                    {prop:"aTime", label:"时间", minWidth:100,formatter:this.dateFormat},
                    {prop:"descri", label:"地点", minWidth:100},
                    {prop:"mould", label:"模具名称", minWidth:220},
                    {prop:"number", label:"模具数量", minWidth:120},
                    ...
                    {prop:"logis", label:"运输人", minWidth:120},
                    {prop:"material", label:"材料名称", minWidth:120},
