<template>
  <div class="page-container">
    ...
    <!--表格内容栏-->
    <kr-table :height="350" permsEdit="sys:dict:edit" permsDelete="sys:dict:delete"
    ...
    export default {
        ...
        data() {
            return {
                ...
                columns: [
                    ...
                    {prop:"cmName", label:"公司名称", minWidth:100},
                    {prop:"cmAddress", label:"公司地址", minWidth:100},
                    {prop:"cmContacts", label:"联系人", minWidth:80},
                    {prop:"cmPhone", label:"电话", minWidth:80},
                    {prop:"cmRemarks", label:"备注", minWidth:120},
        ...
        methods: {
            ...
            findPage: function (data) {
                ...
                this.pageRequest.columnFilters = {cmName: {name:'cmName', value:this.filters.cmName}}
