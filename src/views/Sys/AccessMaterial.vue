  ...
  <div class="page-container">
    ...
    <div class="toolbar" style="float:left;padding-top:10px;padding-left:15px;">
      <el-form :inline="true" :model="filters" :size="size">
        ...
        <el-form-item>
          <el-input v-model="filters.com" placeholder="材料来源"/>
        </el-form-item>
    ...
    <el-dialog :title="operation?'新增':'编辑'" width="40%" :visible.sync="editDialogVisible" :close-on-click-modal="false">
      <el-form :model="dataForm" label-width="120px" :rules="dataFormRules" ref="dataForm" :size="size">
        ...
        <el-form-item label="材料来源" prop="label">
          <el-input v-model="dataForm.com" auto-complete="off"></el-input>
        </el-form-item>
    ...
    methods: {
      ...
      findPage: function (data) {
        ...
        this.pageRequest.columnFilters = {name: {name:'name', value:this.filters.name},mName: {name:'mName', value:this.filters.mName},
          waixie: {name:'waixie', value:this.filters.waixie},com: {name:'com', value:this.filters.com},
