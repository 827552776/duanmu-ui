  ...
  <div class="page-container">
    ...
    <div class="toolbar" style="float:left;padding-top:10px;padding-left:15px;">
      <el-form :inline="true" :model="filters" :size="size">
        <el-form-item>
          <el-input v-model="filters.name" placeholder="焊材名称"></el-input>
        </el-form-item>
        <el-form-item>
          <el-input v-model="filters.deCompany" placeholder="出售单位"></el-input>
        </el-form-item>
        <el-form-item>
          <el-input v-model="filters.model" placeholder="型号"></el-input>
        </el-form-item>
        <el-form-item>
...
<!--        </el-form-item>-->
    ...
    <!--表格内容栏-->
    <HanCaiShouTable :height="500" permsEdit="sys:dict:edit" permsDelete="sys:dict:delete"
    ...
    <el-dialog :title="operation?'新增':'编辑'" width="80%" :visible.sync="editDialogVisible" :close-on-click-modal="false">
      <el-form :model="dataForm" label-width="120px" :rules="dataFormRules" ref="dataForm" :size="size">
        ...
        <el-row>
          ...
          <el-col :span="5">
            <el-form-item label="出售公司" prop="label">
        ...
        <el-row>
          ...
          <el-col :span="5">
            <el-form-item label="出售时间" prop="sort">
              <el-date-picker
          ...
          <el-col :span="6">
            <!--    出库时显示        -->
            <el-form-item label="出售数量" prop="type">
...
<script>
    ...
    import HanCaiShouTable from "../Core/HanCaiShouTable";
    export default {
        components:{
            KtTable,
            KtButton,
        ...
        data() {
            return {
                ...
                columns: [
                    ...
                    {prop:"deTime", label:"销售出库时间", minWidth:120,formatter:this.dateFormat},
